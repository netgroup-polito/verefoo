...
import tests.examples.PolitoDoubleFwTest;
 ...
 *
 */
public class Polito_DoubleFwTest{
    ...
    {
    	Polito_DoubleFwTest p = new Polito_DoubleFwTest();
    	p.resetZ3();
...
//    	    System.out.println( "Last recv_time -> " +ret.last_recv_time);
    	...
    	p.resetZ3();
    	model = new PolitoDoubleFwTest(p.ctx);

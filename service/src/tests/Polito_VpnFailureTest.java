...
import tests.examples.PolitoVpnFailureTest;

public class Polito_VpnFailureTest {
    ...
    {
    	Polito_VpnFailureTest p = new Polito_VpnFailureTest();
    	p.resetZ3();
    	PolitoVpnFailureTest model = new PolitoVpnFailureTest(p.ctx);
    	IsolationResult ret =model.check.checkIsolationProperty(model.politoClient,model.politoServer);

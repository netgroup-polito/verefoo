...
public class Test{
    ...
    public static void main(String[] args) throws Z3Exception{
        ...
        for(;k<10;k++){
            ...
            IsolationResult ret =model.check.checkIsolationProperty(model.webclient, model.webserver);
        ...
        System.out.printf("Mean execution time webclient -> webserver: %.16f", ((float) t/(float)1000)/k);
    }
}

...
public class SubstratesController {
	 ...
	 */
    @ApiOperation(value = "getSubstrates", notes = "searches subtrate networks"
	)
	 ...
	 */
    @ApiOperation(value = "deleteSubstrates", notes = "delete all the substrate networks"
	)
	 ...
	 */
    @ApiOperation(value = "updateSubstrate", notes = "update a single substrate network"
	)
	 ...
	 */
    @ApiOperation(value = "getSubstrate", notes = "retrieve a single substrate network"
	)
	 ...
	 */
    @ApiOperation(value = "deleteSubstrate", notes = "delete a single substrate"
	)
	 ...
	 */
    @ApiOperation(value = "updateHost", notes = "update a single host"
	)
	 ...
	 */
    @ApiOperation(value = "getHost", notes = "retrieve a single host"
	)
	 ...
	 */
    @ApiOperation(value = "deleteHost", notes = "delete a single host"
	)
	 ...
	 */
    @ApiOperation(value = "updateConnections", notes = "update the connections of a substrate network"
	)
	 ...
	 */
    @ApiOperation(value = "getConnections", notes = "retrieve the connections of a substrate network"
	)
    ...
    /**
	 * @param sid it is the id of the substrate network whose connections must be deleted
	 */
    @ApiOperation(value = "deleteConnections", notes = "delete the connections of a substrate network"
	)

...
public class TestCaseGeneratorMaximalFlows {
	NFV nfv;
	String name;
	...
	public TestCaseGeneratorMaximalFlows(String name, int numberAllocationPlaces, int numberWebClients, int numberWebServers, 

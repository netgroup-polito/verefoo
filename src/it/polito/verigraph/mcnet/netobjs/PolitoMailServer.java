...
public class PolitoMailServer extends NetworkObject{
    ...
    private void mailServerRules (){
        ...
        constraints.add( ctx.mkForall(new Expr[]{n_0, p_0},
                ctx.mkImplies((BoolExpr)nctx.send.apply(politoMailServer, n_0, p_0),
       ...
       /* constraints.add( ctx.mkForall(new Expr[]{n_0, p_0},
        ...
        constraints.add( ctx.mkForall(new Expr[]{n_0, p_0},
                ctx.mkImplies((BoolExpr)nctx.recv.apply(n_0,politoMailServer, p_0),
    	...
    	constraints.add( ctx.mkForall(new Expr[]{n_0, p_0}, 
                ctx.mkImplies((BoolExpr)nctx.send.apply(politoMailServer, n_0, p_0), 
                    ctx.mkExists(new Expr[]{p_1}, 
                        ctx.mkAnd(
                        		(BoolExpr)nctx.recv.apply(n_0, politoMailServer, p_1),

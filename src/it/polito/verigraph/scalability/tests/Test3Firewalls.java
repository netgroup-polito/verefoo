...
public class Test3Firewalls {
    ...
    public  Test3Firewalls(){
          ...
          NetContext nctx = new NetContext (ctx,new String[]{"a", "b","c", "fw1","fw2","fw3"},
                                                  new String[]{"ip_a", "ip_b","ip_c", "ip_fw1","ip_fw2","ip_fw3"});
          ...
          rt1.add(new Tuple<DatatypeExpr,NetworkObject>(nctx.am.get("ip_a"), fw1));

          net.routingTable(a, rt1);
          
          ArrayList<Tuple<DatatypeExpr,NetworkObject>> rtc = new ArrayList<Tuple<DatatypeExpr,NetworkObject>>();
          rtc.add(new Tuple<DatatypeExpr,NetworkObject>(nctx.am.get("ip_fw1"), fw1));
          rtc.add(new Tuple<DatatypeExpr,NetworkObject>(nctx.am.get("ip_fw2"), fw1));
          rtc.add(new Tuple<DatatypeExpr,NetworkObject>(nctx.am.get("ip_fw3"), fw1));
          rtc.add(new Tuple<DatatypeExpr,NetworkObject>(nctx.am.get("ip_b"), fw1));
          rtc.add(new Tuple<DatatypeExpr,NetworkObject>(nctx.am.get("ip_a"), fw1));
          rtc.add(new Tuple<DatatypeExpr,NetworkObject>(nctx.am.get("ip_c"), fw1));
          ...
          rt2.add(new Tuple<DatatypeExpr,NetworkObject>(nctx.am.get("ip_c"), fw3));
          rt2.add(new Tuple<DatatypeExpr,NetworkObject>(nctx.am.get("ip_b"), fw3));
          ...
          rt4.add(new Tuple<DatatypeExpr,NetworkObject>(nctx.am.get("ip_c"),fw1));
          ...
          rt5.add(new Tuple<DatatypeExpr,NetworkObject>(nctx.am.get("ip_c"),fw2));

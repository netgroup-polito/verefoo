...
public class TestFirewallCorrectness {
	...
	private VerifooSerializer test(String file) throws Exception{
	...
	public void testFWCorrectness01(){
		try {
			VerifooSerializer result = test( "./testfile/FWCorrectness/FWCorrect01.xml"); 
	...
	public void testFWCorrectness02(){
		try {
			VerifooSerializer result = test( "./testfile/FWCorrectness/FWCorrect02.xml"); 
			assertTrue(!result.isSat());
		} catch (Exception e) {
			fail(e.toString());
		}
	...
	public void testFWCorrectness03(){
		try {
			VerifooSerializer result = test( "./testfile/FWCorrectness/FWCorrect03.xml"); 
			assertTrue(result.isSat());
	...
	public void testFWCorrectness04(){
		try {
			VerifooSerializer result = test( "./testfile/FWCorrectness/FWCorrect04.xml"); 
			assertTrue(result.isSat());
			List<Node> listFW = result.getNfv().getGraphs().getGraph().get(0).getNode().stream().filter(n -> n.getFunctionalType().equals(FunctionalTypes.FIREWALL)).collect(Collectors.toList());
			assertTrue(listFW.size() == 1);
			Node node = listFW.get(0);
	...
	public void testFWCorrectness05(){
		try {
			VerifooSerializer result = test( "./testfile/FWCorrectness/FWCorrect05.xml"); 
			assertTrue(result.isSat());
			List<Node> listFW = result.getNfv().getGraphs().getGraph().get(0).getNode().stream().filter(n -> n.getFunctionalType().equals(FunctionalTypes.FIREWALL)).collect(Collectors.toList());
			assertTrue(listFW.size() == 1);
			Node node = listFW.get(0);
	...
	public void testFWCorrectness06(){
		try {
			VerifooSerializer result = test( "./testfile/FWCorrectness/FWCorrect06.xml"); 
			assertTrue(result.isSat());
			List<Node> listFW = result.getNfv().getGraphs().getGraph().get(0).getNode().stream().filter(n -> n.getFunctionalType().equals(FunctionalTypes.FIREWALL)).collect(Collectors.toList());
	...
	public void testFWCorrectness07(){
		try {
			VerifooSerializer result = test( "./testfile/FWCorrectness/FWCorrect07.xml"); 
			assertTrue(result.isSat());
			List<Node> listFW = result.getNfv().getGraphs().getGraph().get(0).getNode().stream().filter(n -> n.getFunctionalType().equals(FunctionalTypes.FIREWALL)).collect(Collectors.toList());
	...
	public void testFWCorrectness08(){
		try {
			VerifooSerializer result = test( "./testfile/FWCorrectness/FWCorrect08.xml"); 
			assertTrue(result.isSat());
			List<Node> listFW = result.getNfv().getGraphs().getGraph().get(0).getNode().stream().filter(n -> n.getFunctionalType().equals(FunctionalTypes.FIREWALL)).collect(Collectors.toList());
			assertTrue(listFW.size() == 2);
	...
	public void testFWCorrectness09(){
		try {
			VerifooSerializer result = test( "./testfile/FWCorrectness/FWCorrect09.xml"); 
			assertTrue(result.isSat());
			List<Node> listFW = result.getNfv().getGraphs().getGraph().get(0).getNode().stream().filter(n -> n.getFunctionalType().equals(FunctionalTypes.FIREWALL)).collect(Collectors.toList());
			assertTrue(listFW.size() == 1);
	...
	public void testFWCorrectnessLoop(){
		try {
			VerifooSerializer result = test( "./testfile/FWCorrectness/FWCorrectLoop.xml"); 
			assertTrue(result.isSat());
			List<Node> listFW = result.getNfv().getGraphs().getGraph().get(0).getNode().stream().filter(n -> n.getFunctionalType().equals(FunctionalTypes.FIREWALL)).collect(Collectors.toList());

...
/**
 * This class generates a Map of a new network object and its associated node.
...
public class NodeNetworkObject extends HashMap<Node, NetworkObject>{
	...
	/**
	 * Collect the information to generate a network object
	 * @param ctx Z3 Context
	 * @param nctx NetworkContext
	 * @param autoctx the z3 autocontext
	 * @param net Network
	 * @param nodes List of nodes from that we will generate NetworkObject
	 * @param nRules the number of rules that needs to be autogenerated
	 * @param nodeMetrics the node resources requirements

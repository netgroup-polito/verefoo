 ...
 *       &lt;sequence>
 *         &lt;element name="pathNode" maxOccurs="unbounded" minOccurs="2">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
...
public class Path {
    ...
    protected List<Path.PathNode> pathNode;
     ...
     * 
     */
    public List<Path.PathNode> getPathNode() {
        if (pathNode == null) {
            pathNode = new ArrayList<Path.PathNode>();
        }

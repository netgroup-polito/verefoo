...
public class PolitoMultipathTest {
	...
	public	PolitoMultipathTest(Context ctx){
			...
			rtClient.add(new RoutingTable(nctx.am.get("ip_b"), x1, a_y1, nctx.x11));
			rtClient.add(new RoutingTable(nctx.am.get("ip_b"), x1, a_y2, nctx.x12));
						
			ArrayList<RoutingTable> rtX1 = new ArrayList<RoutingTable>();
			rtX1.add(new RoutingTable(nctx.am.get("ip_b"), x2,0,ctx.mkAnd(nctx.x11,nctx.x21)));
			rtX1.add(new RoutingTable(nctx.am.get("ip_b"), x2,y1_y2,ctx.mkAnd(nctx.x11,nctx.x22)));
			rtX1.add(new RoutingTable(nctx.am.get("ip_b"), x2,y1_y2,ctx.mkAnd(nctx.x12,nctx.x21)));
			rtX1.add(new RoutingTable(nctx.am.get("ip_b"), x2,0,ctx.mkAnd(nctx.x12,nctx.x22)));
								
			ArrayList<RoutingTable> rtX2 = new ArrayList<RoutingTable>();
			rtX2.add(new RoutingTable(nctx.am.get("ip_b"), x3,0,ctx.mkAnd(nctx.x21,nctx.x31)));
			rtX2.add(new RoutingTable(nctx.am.get("ip_b"), x3,y1_y2,ctx.mkAnd(nctx.x21,nctx.x32)));
			rtX2.add(new RoutingTable(nctx.am.get("ip_b"), x3,y1_y2,ctx.mkAnd(nctx.x22,nctx.x31)));
			rtX2.add(new RoutingTable(nctx.am.get("ip_b"), x3,0,ctx.mkAnd(nctx.x22,nctx.x32)));
		
			ArrayList<RoutingTable> rtX3 = new ArrayList<RoutingTable>();
			rtX3.add(new RoutingTable(nctx.am.get("ip_b"), b,y1_b,nctx.x31));
			rtX3.add(new RoutingTable(nctx.am.get("ip_b"), b,y2_b,nctx.x32));

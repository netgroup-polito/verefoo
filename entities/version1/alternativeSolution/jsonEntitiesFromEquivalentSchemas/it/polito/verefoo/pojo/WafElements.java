...
public class WafElements {
    ...
    public String toString() {
        ...
        sb.append(WafElements.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("action");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof WafElements) == false) {
            return false;
        }
        WafElements rhs = ((WafElements) other);

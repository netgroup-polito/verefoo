...
public class Tmp {
    ...
    @JsonProperty("node")
    @Valid
    private List<Node__1> node = new ArrayList<Node__1>();
    ...
    @JsonProperty("node")
    public List<Node__1> getNode() {
        return node;
    }

    @JsonProperty("node")
    public void setNode(List<Node__1> node) {
        this.node = node;
    }
    ...
    public String toString() {
        ...
        sb.append(Tmp.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
